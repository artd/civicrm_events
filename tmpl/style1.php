...
?>
<div>
	<h2><a href="<?php echo $event->link; ?>" title="<?php echo $event->title; ?>" class="mod_civicrm_events_link"<?php echo $modal ? ' rel="{handler: \'iframe\', size: {x: 580, y: 450}}"' : ''; ?>><?php echo $event->title; ?></a></h2>
